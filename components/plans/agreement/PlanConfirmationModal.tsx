      ...
      <Pressable style={styles.backdrop} onPress={onCancel}>
        <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
          ...
          <View style={styles.row}>
            ...
            <Pressable onPress={onConfirm} style={[styles.btn, styles.btnDanger]}>
              <Text style={styles.btnDangerTxt}>{confirmLabel}</Text>
            </Pressable>
          </View>
        </Pressable>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  btnDanger: { backgroundColor: colors.secondary },
  btnDangerTxt: { fontSize: 16, fontWeight: '800', color: '#fff' },
});
