...
export function MeetupFundingReminderBanner({ meetupIso, role }: Props) {
  ...
  return (
    <View style={styles.wrap}>
      <LinearGradient
        colors={['rgba(245, 158, 11, 0.18)', 'rgba(255, 74, 114, 0.06)', 'transparent']}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 14, fontWeight: '600', color: colors.textMuted, lineHeight: 20, fontFamily: fonts.medium, },
  hintRow: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    gap: 6,
  ...
  hint: { flex: 1, fontSize: 12, fontWeight: '600',
